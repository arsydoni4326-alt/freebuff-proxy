...
Options:
  --url URL           Base URL (default: http://127.0.0.1:3457 or $FREEBUFF_HOST)
  --key-file PATH     Path to API key file (default: api-keys.local)
...
def main():
    ...
    parser.add_argument("--url", default=os.environ.get("FREEBUFF_HOST", "http://127.0.0.1:3457"))
    parser.add_argument("--key-file", default="api-keys.local")
