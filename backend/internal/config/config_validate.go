...
func (c Config) Validate() error {
	...
	// MATURITY_TOUCH_MODEL accepts "auto" or an explicit provider/model id
	// (the slash is the shape check — config is a bottom-layer package and
	// must not import modelcat; the pool skips misconfigured touches with a
	// warn log).
