...
var keyCatalog = []KeyDef{
	...
	{Key: "AUTO_DISCOVER_TOKEN", Group: GroupGeneral, Kind: "bool",
		Default:     "true",
	...
	{Key: "LOG_LEVEL", Group: GroupGeneral, Kind: "select", Enum: []string{"debug", "info", "warn", "error", "trace"},
		Default:     "info",
	...
	{Key: "SAFE_MODE", Group: GroupGeneral, Kind: "bool",
		Default:     "true",
	...
	{Key: "BRIDGE_ENABLED", Group: GroupPool, Kind: "bool",
		Default:     "true",
	...
	{Key: "SESSION_PERSIST", Group: GroupPool, Kind: "bool", RestartOnly: true,
		Default:     "false",
		Description: `Persist session state AND active agent runs to disk so a restart resumes them instead of re-creating (new daily slot / re-START).`},
	...
	{Key: "TOKEN_ROTATION", Group: GroupPool, Kind: "select", Enum: []string{"drain", "round_robin", "least_used", "random"},
		Default:     "drain",
	...
	// ── upstream ─────────────────────────────────────────────────────────
	{Key: "COST_MODE", Group: GroupUpstream, Kind: "select", Enum: []string{"free"}, RestartOnly: true,
		Default:     "free",
	...
	{Key: "MODELS_ALLOW", Group: GroupUpstream, Kind: "list",
		Default:     "",
	...
	// ── security ─────────────────────────────────────────────────────────
	{Key: "ADMIN_TOKEN", Group: GroupSecurity, Kind: "secret", Secret: true,
		Default:     "123456",
