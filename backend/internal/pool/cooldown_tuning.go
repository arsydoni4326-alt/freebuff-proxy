...
// quotaProbeMaxInterval caps the quota-probe 429-backoff doubling
// (SMART_PROBE_BACKOFF_MAX_MS; default 30m). Kept on this lineage after the
// upstream smart-probe scheduler was kept deleted in favor of the ADR-0022
// auto-probe: the knob stays live-applied here so the catalog surface and
// cooldown_tuning tests remain intact.
